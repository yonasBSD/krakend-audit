...
func ExampleParse() {
	...
	// details: [3124]
	// agents: []
	// endpoints: [{[2 0 0 140000 0] [{[64] map[]}] map[github.com/devopsfaith/krakend-jose/validator:[]]} {[2 1 1 10000 7] [{[64] map[backend/http/client:[3]]}] map[]} {[2 0 0 10000 8] [{[64] map[]}] map[]}]
